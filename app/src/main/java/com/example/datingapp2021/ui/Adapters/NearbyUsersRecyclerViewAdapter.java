...
public class NearbyUsersRecyclerViewAdapter extends RecyclerView.Adapter<NearbyUsersRecyclerViewAdapter.ViewHolder> {
    ...
    public NearbyUsersRecyclerViewAdapter(boolean isDashboard, Fragment fragment, List<UserDistance> users) {
        setList(users);
